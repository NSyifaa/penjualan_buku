...
$pdf->Cell(30, 6, "Selisih (Bruto)", 1, 1, 'C');
...
while ($data_penjualan = mysqli_fetch_array($ambil_penjualan)) {
    ...
    $pdf->Cell(30, 6, "Rp " . number_format($harga_jual, 0, ',', '.'), 1, 0, 'R');
    $pdf->Cell(30, 6, "Rp " . number_format($selisih, 0, ',', '.'), 1, 1, 'R');
    }
}
...
$pdf->Cell(30, 6, "-", 1, 0, 'R'); // Kosongkan kolom Harga jual
