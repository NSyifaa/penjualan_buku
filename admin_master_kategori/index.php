...
<head>
  ...
  $konstruktor ='admin_master_kategori';
          ...
          <div class="col-lg-6">
            ...
            <div class="card">
              <div class="card-header" style="background-color: #091057;">
                <h3 class="card-title" style="color: white"><i class="nav-icon fas fa-book"></i> Kategori Buku</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-reset" ><i class="nav-icon fas fa-sync"></i> Reset Data</button>
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $no=1;
                    $sql_panggilkategori = mysqli_query($koneksi, "SELECT * FROM tbl_kategori") or die(mysqli_error($koneksi));


                    if(mysqli_num_rows($sql_panggilkategori) > 0)
                    {
                      while($data=mysqli_fetch_array($sql_panggilkategori))
                      {
                        ?>
                        <tr>
                          <td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              ...
              <input type="text" name="id_kategoribuku" id="id_kategoribuku" hidden>
            </div>
