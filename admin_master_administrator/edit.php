...
$id_admin        = trim(mysqli_real_escape_string($koneksi, $_POST['id_adminterpilih2']));
...
$querycek= mysqli_query($koneksi,"UPDATE tbl_pengguna SET username= '$username', nama_user= '$namapengguna', alamat='$alamat',kontak='$kontak' WHERE id ='$id_admin'") or die (mysqli_error($koneksi));
